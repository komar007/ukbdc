...
struct layout PROGMEM scan_codes = {
	...
	.data = {
		...
		{KLEFT_SHIFT},{0},{KZ},{KX},{KC},{KV},{KB},{KN},{KM},{KCOMMA},{KPERIOD},{KSLASH},{0},{KRIGHT_SHIFT},
		{KLEFT_CTRL},{0, ACT(DOWN, ABS), 1, 0},{KLEFT_ALT},{KSPACE},{KRIGHT_ALT},{KRIGHT_GUI},{KRIGHT_GUI},{KRIGHT_CTRL},

		{KESC},{K1},{K2},{K3},{K4},{K5},{K6},{K7},{K8},{K9},{K0},{KMINUS},{KEQUAL},{KBACKSPACE},
		{KTAB},{KA},{KB},{KC},{KD},{KE},{KY},{KU},{KI},{KO},{KP},{KLEFT_BRACE},{KRIGHT_BRACE},{KBACKSLASH},
		{KCAPS_LOCK},{KA},{KS},{KD},{KF},{KG},{KH},{KJ},{KK},{KL},{KSEMICOLON},{KQUOTE},{KBACKSLASH},{KENTER},
		{KLEFT_SHIFT},{0},{KZ},{KX},{KC},{KV},{KB},{KN},{KM},{KCOMMA},{KPERIOD},{KSLASH},{0},{KRIGHT_SHIFT},
		{KLEFT_CTRL},{0, ACT(DOWN, ABS), 0, 0},{KLEFT_ALT},{KSPACE},{KRIGHT_ALT},{KRIGHT_GUI},{KRIGHT_GUI},{KRIGHT_CTRL}
	}
};
