...
#if defined(PLATFORM_ikea) || defined(PLATFORM_alpha) || defined(PLATFORM_gh60)
...
#if defined(PLATFORM_ikea) || defined(PLATFORM_gh60)
...
#if defined(PLATFORM_alpha) || defined(PLATFORM_ikea) || defined(PLATFORM_gh60)
