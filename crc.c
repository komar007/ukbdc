...
static const uint8_t PROGMEM crc_hi_byte[] = {
...
static const uint8_t PROGMEM crc_low_byte[] = {
...
uint16_t crc16(size_t len, const uint8_t *data)
{
        ...
        while (len--) {
                 idx = crc_low ^ *data++;
                 crc_low = crc_hi ^ pgm_read_byte(&crc_hi_byte[idx]);
                 crc_hi = pgm_read_byte(&crc_low_byte[idx]);
        }
